...
class Product(models.Model):
    ...
    pro_desc = models.CharField(max_length=5000)
    pro_adinfo = models.CharField(max_length=25000)
    pro_brand = models.CharField(max_length=150)
    pro_category = models.CharField(max_length=150)
    pro_tag = models.CharField(max_length=1000)
    pro_shippingcharge = models.IntegerField()
